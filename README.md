...
![plot](http://github.com/cwickham/raw/master/locations.png)
...
![plot](http://github.com/cwickham/raw/master/cities.png)
...
![plot](http://github.com/cwickham/raw/master/avg_temp.png)

Or temperature variability by location:

    qplot(Longitude, Latitude, data = subset(site_summaries, n_months > 60), 
      alpha = I(0.5), colour = spread_temp) 
![plot](http://github.com/cwickham/raw/master/var_temp.png)
